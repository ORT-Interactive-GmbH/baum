...
class CategoryHierarchyTest extends CategoryTestCase {
  ...
  public function testLimitDepthScope() {
    ...
    $this->assertEmpty($node->descendants()->limitDepth(0)->pluck('id')->toArray());
  ...
  public function testToHierarchyNestsCorrectlyWithOrder() {
    ...
    $this->assertArraysAreEqual($expectedSubtreeZ, hmap($this->categories('Root Z', OrderedCategory::class)->getDescendantsAndSelf()->toHierarchy()->toArray()));
  }
